# What should someone do before using CryptoUnion?

Before doing anything on CryptoUnion you're strongly encouraged to go over the Academy section and get familiar with essential aspects of cryptocurrency and DeFi ecosystem.
...
Apart from Academy, users are recommended to go over CryptoUnion terms (Settings > About section) and make sure they understand what CryptoUnion wallet is and risks involved in using the app.
